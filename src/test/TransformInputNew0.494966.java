	...
	public static void specialWeatherMap(String weatherInfo, List<Integer> specialWeatherResult)
	{
		...
		if (weatherInfo.contains("通行能力下降")) {
		    ...
		    if (m1.find()) {
			    ...
			    if (m2.find()) {
					specialWeatherResult.set(10, Integer.parseInt(m2.group(0)));
				}
			}
		}
		if (weatherInfo.contains("能见度")) {
		    ...
		    if (m1.find()) {
			    ...
			    Matcher m2 = r2.matcher(m1.group(0));
			    if (m2.find()) {
					specialWeatherResult.set(11, Integer.parseInt(m2.group(0)));
				}
			}
		}
		if (weatherInfo.contains("云")) {
		    ...
		    if (m1.find()) {
			    ...
			    Matcher m2 = r2.matcher(m1.group(0));
			    if (m2.find()) {
					specialWeatherResult.set(12, Integer.parseInt(m2.group(0)));
				}
			}
		}
	}
